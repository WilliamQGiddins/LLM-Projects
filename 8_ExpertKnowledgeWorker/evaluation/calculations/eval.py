...
from evaluation.calculations.test import TestQuestion, load_tests
from rag_implementation.answer import DB_NAME, answer_question, fetch_context
...
def evaluate_answer(test: TestQuestion) -> tuple[AnswerEval, str, list]:
    ...
    # Call LLM evaluator
    response = openai.chat.completions.create(model=MODEL, messages=evaluator_messages, response_format=AnswerEval)

    answer_eval = AnswerEval.model_validate_json(response.choices[0].message.content)
